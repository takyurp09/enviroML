...
## Original course work (Fall 2023)

- Problem framing, assigned datasets, and assignment sequence
- Initial Python notebooks/scripts and course presentations
...
- Permutation importance evaluated on test observations
- Systematic cluster-number selection and 200-run bootstrap stability analysis
- Chronological climate validation and cyclic time features
- Reproducible figures, machine-readable results, tests, and documentation
